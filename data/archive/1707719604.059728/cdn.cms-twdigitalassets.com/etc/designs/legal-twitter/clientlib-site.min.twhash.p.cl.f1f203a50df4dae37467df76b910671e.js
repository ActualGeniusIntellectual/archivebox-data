...
if(typeof E!=="undefined"){E.addEventListener("click",function(J){var I=r(this,".nav-drawer");
...
if(typeof B!=="undefined"){A.addEventListener("click",function(I){I.preventDefault();
p=true;
t(H,"active");
return false
})
...
(function(){document.addEventListener("DOMContentLoaded",function(){a()
},false);
function a(){if(typeof window.twtrScribe!=="undefined"){window.twtrScribe.log("page","page-view")
}}})();